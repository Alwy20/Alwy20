...
namespace TheCoffeMechine
{
    class CoffeMechine
    {
        ...
        public CoffeMechine(CoffePowder powder, WaterGalon galon,Milk milks)
        {
        ...
        {
            return $"the water :{this.waterGalon.getVolume()} and the coffe powder : {this.coffePowder.getNetto()} the milk :{this.milk.getml()}";
        }
    }
}
